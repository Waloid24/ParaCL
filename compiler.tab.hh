...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_NONEQUAL ()
      {
        return symbol_type (token::NONEQUAL);
      }
#else
      static
      symbol_type
