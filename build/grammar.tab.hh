...
/**
 ** \file /home/andrey/Desktop/DREC/ilab/ParaCL/build/grammar.tab.hh
...
#ifndef YY_YY_HOME_ANDREY_DESKTOP_DREC_ILAB_PARACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
# define YY_YY_HOME_ANDREY_DESKTOP_DREC_ILAB_PARACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
// "%code requires" blocks.
#line 12 "generators/parser.y"
...
#line 56 "/home/andrey/Desktop/DREC/ilab/ParaCL/build/grammar.tab.hh"
...
namespace yy {
#line 191 "/home/andrey/Desktop/DREC/ilab/ParaCL/build/grammar.tab.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // term
      // primary
      char dummy2[sizeof (nodes::Base_node*)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_DIV = 26,                              // "/"
        S_ERR = 27,                              // ERR
        S_INTEGER = 28,                          // INTEGER
        S_ID = 29,                               // ID
        S_YYACCEPT = 30,                         // $accept
        S_program = 31,                          // program
        S_stms = 32,                             // stms
        S_scope = 33,                            // scope
        S_open_scope = 34,                       // open_scope
        S_close_scope = 35,                      // close_scope
        S_statement = 36,                        // statement
        S_open_statement = 37,                   // open_statement
        S_closed_statement = 38,                 // closed_statement
        S_simple_statement = 39,                 // simple_statement
        S_assign = 40,                           // assign
        S_lval = 41,                             // lval
        S_expression = 42,                       // expression
        S_boolean = 43,                          // boolean
        S_arithmetic = 44,                       // arithmetic
        S_term = 45,                             // term
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_primary: // primary
        value.move< nodes::Base_node* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, nodes::Base_node*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const nodes::Base_node*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_term: // term
      case symbol_kind::S_primary: // primary
        value.template destroy< nodes::Base_node* > ();
        break;
...
#line 1669 "/home/andrey/Desktop/DREC/ilab/ParaCL/build/grammar.tab.hh"




#endif // !YY_YY_HOME_ANDREY_DESKTOP_DREC_ILAB_PARACL_BUILD_GRAMMAR_TAB_HH_INCLUDED
